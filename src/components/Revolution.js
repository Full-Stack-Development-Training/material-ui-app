  ...
  return (
    <Grid container direction="column">
        ...
        <Grid item container direction="column" lg style={{ maxWidth: "40em" }}>
          ...
          <Grid item>
            ...
            >
              ...
              helping them overcome life&apos;s obstacles. Each project is a
        ...
        >
          <Grid item>
            <Typography
              ...
              alignItems={matchesMD ? "center" : "right"}
            >
              Consultation
            </Typography>
          </Grid>
      ...
      >
        ...
        >
          ...
          <Grid item>
            ...
            >
              ...
              screen and every anticipated feature. align=
              {matchesMD ? "center" : "right"}
            </Typography>
            <Typography
              variant="body1"
              paragraph
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={review} alt="magnifying glass" width="100%" style={{maxWidth: 500}} />
        </Grid>
      </Grid>
      <Grid
        item
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={iterate} alt="falling dominoes" width="100%" style={{maxWidth: 1000}} />
        </Grid>
      </Grid>
    </Grid>
  );
